...
public class MyDriverMultiThreader {

	//for multiple threading
		 private static ThreadLocal<WebDriver> DriverPool = new ThreadLocal<>();

		    private MyDriverMultiThreader() { 
		  }
		    
		        
		    public static WebDriver get() {
		    /*another version :for multiple threading
		     ...
		     */
		        ...
		        if (DriverPool.get() == null) {
		            ...
		            String browserParamFromEnv = System.getProperty("browser"); //where in system?
		            
		            // this line will tell which browser should open based on the value from properties file
		            String browser 
		            	= (browserParamFromEnv == null) 
		            		? ConfigurationReaderAT.getProperty("browser") //if true
		            		: browserParamFromEnv;						//if false
